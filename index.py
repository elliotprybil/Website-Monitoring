#Scrapper for Kith website with free proxies. Obviously better if you can use your own proxies. 
#Linked to a discord channel. You just have to add your own link. 
...
def monitor():
    ...
    hook = Webhook("HERE ADD YOUR OWN WEBHOOK")
